...
local eq = function(a, b)
    assert(a == b, string.format("%s was not equqal to %s", a, b))
end

local ji_globals = require('ji.globals')

local convert_vimoption_to_lua = ji_globals.convert_vimoption_to_lua
local opt = ji_globals.opt
